...
public class EnemyDeadParticleInitiation : MonoBehaviour
{
    [Header("Reference")]
    ...
    private IEnumerator SpawnBodyParticles()
    {
        ...
        {
            var prefabs = PoolManager.SpawnObject(part, _enemy.transform.position, Quaternion.identity, PoolManager.PoolType.GameObjects);
